...
namespace Tomnaia.Migrations
{
    ...
    [Migration("20240607073815_rideOffer")]
    partial class rideOffer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tomnaia.Entities.RideOffer", b =>
                {
                    b.Property<string>("RideOfferId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Tomnaia.Entities.RideOffer", b =>
                {
                    ...
                    b.HasOne("Tomnaia.Entities.Ride", "RideRequest")
                        .WithMany()
                        .HasForeignKey("RideRequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
